...
class DefaultArtifactCacheLockingManagerTest extends Specification {
    ...
    def recentlyUsedGradleVersions = Stub(RecentlyUsedGradleVersions)

    @Subject @AutoCleanup
    def cacheLockingManager = new DefaultArtifactCacheLockingManager(cacheRepository, artifactCacheMetadata, fileAccessTimeJournal, cleanupActionFactory, recentlyUsedGradleVersions)
