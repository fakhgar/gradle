...
class RecentlyUsedGradleVersionsFromGradleUserHomeCachesTest extends Specification {
    ...
    @Subject RecentlyUsedGradleVersions versions = new RecentlyUsedGradleVersionsFromGradleUserHomeCaches(cacheScopeMapping)
    ...
    def "returns Gradle versions from version-specific cache directories"() {
        ...
        when:
        def versions = versions.getRecentlyUsedGradleVersions()
