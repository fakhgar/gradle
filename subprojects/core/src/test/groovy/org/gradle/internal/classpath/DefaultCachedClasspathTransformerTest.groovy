...
class DefaultCachedClasspathTransformerTest extends Specification {
    ...
    @Subject
    DefaultCachedClasspathTransformer transformer = new DefaultCachedClasspathTransformer(cacheRepository, jarCache, fileAccessTimeJournal, [jarFileStore], recentlyUsedGradleVersions)
