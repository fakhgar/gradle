...
import org.gradle.cache.internal.RecentlyUsedGradleVersionsFromGradleUserHomeCaches;
...
public class GradleUserHomeScopeServices {
    ...
    CachedClasspathTransformer createCachedClasspathTransformer(CacheRepository cacheRepository, FileHasher fileHasher, FileAccessTimeJournal fileAccessTimeJournal,
                                                                List<CachedJarFileStore> fileStores, RecentlyUsedGradleVersions recentlyUsedGradleVersions) {
        return new DefaultCachedClasspathTransformer(cacheRepository, new JarCache(fileHasher), fileAccessTimeJournal, fileStores, recentlyUsedGradleVersions);
    }
    ...
    RecentlyUsedGradleVersions createRecentlyUsedGradleVersions(CacheScopeMapping cacheScopeMapping) {
        return new RecentlyUsedGradleVersionsFromGradleUserHomeCaches(cacheScopeMapping);
    }
}
