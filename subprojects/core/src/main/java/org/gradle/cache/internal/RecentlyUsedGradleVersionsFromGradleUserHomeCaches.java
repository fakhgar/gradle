...
public class RecentlyUsedGradleVersionsFromGradleUserHomeCaches implements RecentlyUsedGradleVersions {

    private final VersionSpecificCacheDirectoryScanner directoryScanner;

    public RecentlyUsedGradleVersionsFromGradleUserHomeCaches(CacheScopeMapping cacheScopeMapping) {
